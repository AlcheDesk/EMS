...
public class WorkerTypeTypeHandler extends BaseTypeHandler<String> {

    @Override
    public void setNonNullParameter(PreparedStatement ps, int i, String parameter, JdbcType jdbcType)
            throws SQLException {
        Long jobTypeId = RuntimeVariables.getWorkerTypeToIdMap().get(parameter);
        if (jobTypeId == null) {
            ps.setLong(i, 0);
        }
        else {
    ...
    public String getNullableResult(ResultSet rs, String columnName) throws SQLException {
        ...
        if (jobTypeId == 0) {
            ...
            return RuntimeVariables.getIdToWorkerTypeMap().get(jobTypeId);
        }
    }
